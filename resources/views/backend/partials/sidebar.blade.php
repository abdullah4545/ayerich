<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        <a href="{{ url('/admin/dashboard') }}" class="navbar-brand mx-4 mb-3">
            <h3 class="text-warning"><i class="fa fa-user-edit me-2"></i>DarkPan</h3>
        </a>
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                @if (Auth::guard('admin')->user()->id == 1)
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                            class="fa fa-laptop me-2"></i>Shops</a>
                ...
                @else
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                            class="fa fa-laptop me-2"></i>H.R / Executive</a>
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="{{ url('admin/executive') }}" class="dropdown-item">H.R / Executive</a>
                    </div>
                @endif
            ...
            @if (Auth::guard('admin')->user()->id == 1)
                <a href="{{ url('admin/supporttikits') }}" class="nav-item nav-link"><i
                        class="fa fa-keyboard me-2"></i>Support Tickets</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        ...
                        <a href="{{ url('admin/information/terms_codition') }}" class="dropdown-item">Terms
                            Conditions</a>
                        <a href="{{ url('admin/information/shipping_guide') }}" class="dropdown-item">Shipping
                            Guide</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="{{ route('admin.servicepackages.index') }}" class="dropdown-item">Service
                            Package</a>
                        <a href="{{ route('admin.basicinfos.index') }}" class="dropdown-item">Basic Info</a>
                        <a href="{{ route('admin.leadershipranks.index') }}" class="dropdown-item">Leadership
                            Bonus</a>

                        <a href="{{ route('admin.ranks.index') }}" class="dropdown-item">Ranks
                            Bonus</a>
