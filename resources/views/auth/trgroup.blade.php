    ...
    <div class="container pt-4 mt-4">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="card p-2">
                    <h1 class="text-center">Transfer Your Group Bonus</h1>
                    <div class="row p-4">
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled class="form-control" id="from_wallet"
                                        value="Group Bonus" name="from_wallet">
                                </div>
                                <div class="form-group">
                                    <label for="Amount">Available Amount</label>
                                    <input type="text" class="form-control"
                                        value="{{ number_format((float) Auth::guard('web')->user()->group_bonus, 2, '.', '') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" min="20"
                                        max="{{ number_format((float) Auth::guard('web')->user()->group_bonus, 2, '.', '') }}"
