...
<div class="outer-top-xs outer-bottom-xs">
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="d-flex" id="lgnone"
                    style="justify-content: space-between;padding: 10px;    background: white;">
                    ...
                    @if (isset(Auth::user()->name))
                        <div class="svg_text" style="font-size: 14px;padding-top: 8px;font-weight: bold;">
                            {{ Auth::user()->name }}</div>
                    @else
                    @endif
                ...
                <div class="p-0" id="psm">
                    <div class="row">
                        <div class="col-lg-3 col-xs-6 mb-4">
                            <div class="account">
                                <div class="card text-center bg-danger pt-4 user_card_text"
                                    style="font-size: 26px;padding-top: 14px !important;">
                                    <a href="{{ url('user/shops') }}">
                                        <img src="{{ asset('public/shop.png') }}"
                                            style="width: 50%;padding: 8px 10px;padding-bottom:3px">
                                    </a>
                                    <a href="{{ url('user/shops') }}" class="btn btn-primary"
                                        style="width:100%;background:none;color:black">Shop Now</a>
                            ...
                            <div class="account">
                                <div class="card text-center bg-danger pt-4 user_card_text" style="font-size: 26px;">
                                    <a type="button" class="btn" data-toggle="modal"
                                        data-target="#exampleModalCenter" style="padding-bottom: 0;">
                                        <img src="{{ asset('public/payment.png') }}"
                                            style="width: 50%;padding: 8px 10px;">
                                    </a>
                                    <a type="button" class="btn btn-primary" style="background:none;color:black"
                                        data-toggle="modal" data-target="#exampleModalCenter">Mobile Recharge</a>
                        ...
                        <div class="col-lg-3 col-xs-6 mb-4">
                            <div class="account">
                                <div class="card text-center bg-danger pt-4 user_card_text" style="font-size: 26px;">
                                    <a href="{{ url('user/fixeddeposits') }}" class="btn" style="padding-bottom: 0;">
                                        <img src="{{ asset('public/bank.png') }}" style="width: 50%;padding: 8px 10px;">
                                    </a>
                                    <a href="{{ url('user/fixeddeposits') }}" class="btn btn-primary"
                                        style="background:none;color:black">Fixed Deposit</a>
                        ...
                        <div class="col-lg-3 col-xs-6 mb-4">
                            <div class="account">
                                <div class="card text-center bg-danger pt-4 user_card_text" style="font-size: 26px;">
                                    <a type="button" class="btn" data-toggle="modal"
                                        data-target="#exampleModalCenter" id="plg">
                                        <div class="d-flex"
                                            style="font-size: 22px;justify-content: center;padding: 10px 14px;">
                                            <div id="valueaa">0</div>.<div id="value">100</div>
                                        </div>
                                    </a>
                                    <a type="button" class="btn btn-primary" style="background:none;color:black"
                                        data-toggle="modal" data-target="#exampleModalCenter">Future Fund</a>
                            ...
                            <div class="card">
                                <div class="row" style="font-size: 25px;font-weight: bold;padding: 8px;">
                                    ...
                                    <div class="col-lg-3 col-xs-12" style="text-align: right;">
                                        ...
                                        <button id="copyreflink"
                                            style="background: none;border: 1px solid #0f6cb2;color: black;"
