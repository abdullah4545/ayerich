                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                <label for="ProductSalePrice">Discount % <span
                                                        class="text-danger">*</span></label>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                <label for="ProductSalePrice">Bonus Point <span
                                                        class="text-danger">*</span></label>
                                                <input type="number" id="bonus_point" name="bonus_point"
                                                    class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control" id="sub_category_id"
                                                    style="background: black;" name="subcategory_id" required>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <select class="form-control" id="editcategory_id"
                                                    ...
                                                    onchange="editsetsubcategory()" required>
                                                    <option>Select Category</option>
                                                    @forelse ($categories as $category)
                                                        <option value="{{ $category->id }}">
                                                            {{ $category->category_name }}
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#EditProduct').find('#editcategory_id').val(data
                        .category_id);
                    $('#EditProduct').find('#bonus_point').val(data
                        .bonus_point);
        ...
        $('#EditProduct').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#EditProduct').find('#ProductRegularPrice').val('');
                    $('#EditProduct').find('#Discount').val('');
                    $('#EditProduct').find('#bonus_point').val('');
