                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="activity" style=" height: 262px;overflow: auto;">
                                    ...
                                    @foreach ($comments as $comment)
                                        <div class="activity-item d-flex">
                                            ...
                                            <div class="activity-content">
                                                <a href="#" class="fw-bold text-dark">{{ $comment->comment }}</a>
                                            </div>
                ...
                <div class="row">
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            @forelse ($orders as $order)
                                                <tr>
                                                    <th>{{ $order->productCode }}</th>
                                                    <td scope="row"><a href="#"><img
                                                                src="{{ asset('public/image/default.png') }}"
                                                                alt=""></a></td>
                                                    <td><a href="#"
                                                            class="text-primary fw-bold">{{ $order->productName }}</a>
                                                    </td>
                        ...
                        <div class="card recent-sales">
                            ...
                            <div class="filter">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <li><a class="dropdown-item" type="button" onclick="recentsellfilter(0)">Today</a>
                                    </li>
                                    <li><a class="dropdown-item" type="button" onclick="recentsellfilter(1)">This
                                            Month</a></li>
                                    <li><a class="dropdown-item" type="button" onclick="recentsellfilter(2)">This
                                            Year</a></li>
                                </ul>
                            </div>

                            <div class="card-body">
                                <h5 class="card-title">Recent Sales <span id="recentselltitle"></span></h5>
                                <div class="table-responsive" style="height: 398px;overflow:auto">
                    ...
                    <div class="col-md-6">
                        <div class="card top-selling">
                            ...
                            <div class="card-body pb-0">
                                <h5 class="card-title">Stock Out <span>| Product</span></h5>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ asset('public/admin/assets/') }}/img/product-1.jpg"
                                                        alt=""></a></th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ asset('public/admin/assets/') }}/img/product-2.jpg"
                                                        alt=""></a></th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ asset('public/admin/assets/') }}/img/product-3.jpg"
                                                        alt=""></a></th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ asset('public/admin/assets/') }}/img/product-4.jpg"
                                                        alt=""></a></th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img
                                                        src="{{ asset('public/admin/assets/') }}/img/product-5.jpg"
                                                        alt=""></a></th>
