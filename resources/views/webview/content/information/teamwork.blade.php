...
<style>
    ...
    #affcard{ 
        ...
        background-image: url(../public/i3.jpg);
        opacity: 0.6;
    }
    #affcardh1{
        margin: auto;
...
<div class="container outer-top-xs outer-bottom-xs">
    <div class="row">
        <div class="col-xs-12">
            <h1 id="affiliateh1">45 Quotes That Celebrate Teamwork, Hard Work, and Collaboration</h1>
        </div>
    </div>
    <div class="row" id="space">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="news d-flex">
                        <img src="{{asset('public/usert.png')}}" id="carimg">
                        <div class="amount">
                            <h4 class="teamh4">Withdrew Now $300 </h4>
                            <span>10-03-2023 3:30 PM</span>
                        </div>
                    </div>
                    <div class="news d-flex">
                        <img src="{{asset('public/usert.png')}}" id="carimg">
                        <div class="amount">
                            <h4 class="teamh4">Withdrew Now $10 </h4>
                            <span>10-03-2023 3:30 PM</span>
                        </div>
                    </div>
                    <div class="news d-flex">
                        <img src="{{asset('public/usert.png')}}" id="carimg">
                        <div class="amount">
                            <h4 class="teamh4">Withdrew Now $40 </h4>
                            <span>10-03-2023 3:30 PM</span>
                        </div>
                    </div>
                    <div class="news d-flex">
        ...
        <div class="col-xs-12 col-md-6">
            ...
            <img src="{{asset('public/i4.jpg')}}" id="" style="width: 100%;border-radius: 6px;margin-top: 10px;">
    ...
    <div class="row" id="space" style="padding-bottom:0px;padding-top:20px">
    ...
    <div class="row" id="space">
        ...
        <div class="col-md-2"></div>
        <div class="col-xs-12 col-md-5" id="smp">
            <img src="{{asset('public/i2.png')}}" id="" style="width: 100%;border-radius: 6px;">
        </div> 
    </div>
