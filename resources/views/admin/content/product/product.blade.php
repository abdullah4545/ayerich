        ...
        <div class="pagetitle row">
            ...
            <div class="col-6" style="text-align: right">
                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                    data-bs-target="#mainProduct"><span style="font-weight: bold;">+</span> Add New Product</button>
                <button type="button" class="btn btn-sync btn-info btn-sm waves-effect waves-light ml-2 float-right"><i
                        class="fas fa-spinner fa-spin mr-1"></i> Product Sync</button>
            </div>
        </div><!-- End Page Title -->
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="single-image image-holder-wrapper clearfix">
                                    <div class="image-holder placeholder">
                                        <img id="prevImage"
                                            style="height: 100px; width:100px;background:white;display:none" />
                            ...
                            <div class="form-group" style="text-align: right">
                                <div class="submitBtnSCourse">
                                    <button type="submit" name="btn"
                                        class="btn btn-primary AddProductBtn btn-block">Save</button>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="card">
                        <div class="card-body pt-4">
                            ...
                            <div class="table-responsive">
                                <table class="table table-centered table-borderless table-hover mb-0" id="productinfo"
                                    width="100%">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form name="form" id="EditProduct" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                <label for="productCode">Product Code</label>
                                <input type="text" id="editproductCode" name="productCode" class="form-control"
                                    required>
                            </div>
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            if (data.status === 'Active') {
                                return '<button type="button" class="btn btn-success btn-sm btn-status" data-status="Inactive" id="statusBtnProduct" data-id="' +
                                    data.id + '">Active</button>';
                            } else {
                                return '<button type="button" class="btn btn-warning btn-sm btn-status" data-status="Active" id="statusBtnProduct" data-id="' +
