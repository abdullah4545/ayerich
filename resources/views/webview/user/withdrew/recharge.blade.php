                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-xl-12 p-2 pb-0 mb-4"
                        ...
                        <div class="h-100 bg-secondary rounded p-2">
                            <h5 class="card-title text-center mt-2" style="color:black">Mobile Recharge</h5>
                            <p class=" text-center" style="width::100%;color:red;">[ NB: You need to pay
                                {{ \App\Models\Basicinfo::first()->charge_withdrew }}% charge for recharge money ]</p>

                            <form id="NewRecharge" name="form" enctype="multipart/form-data"
                                class="from-prevent-multiple-submits">
                                @csrf
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-md-12 m-auto justify-content-center align-items-center">
                                        <div class="form-group mb-3">
                                            <label for="controlInput">From Main Balance</label>
                                            <input type="text" class="form-control " id="balance" name="balance"
                                                value="Main Balance : {{ intval(Auth::user()->main_balance) }}"
                                                placeholder="From Balance" required readonly>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="controlInput1">Recharge Amount</label>
                                            <input type="number" min="1"
                                                max="{{ intval(Auth::user()->main_balance) }}" class="form-control"
                                                name="amount" placeholder="Recharge Amount" required>
                                        </div>
                                        <div class="form-group mb-3">
                                            <label for="controlInput1">Choose Operator</label>
                                            <select name="oparator" id="oparator" class="form-control">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="controlInput1">Phone Number</label>
                    ...
                    <div class="col-sm-12 col-md-12 col-xl-12 p-2 pt-0">
                        <div class="bg-secondary rounded p-2">
                            <h6 class="mb-2 text-center" style="color:black;">Recharge History</h6>
...
<script>
    $(document).ready(function() {
        ...
        $('#NewRecharge').submit(function(e) {
            e.preventDefault();
            $.ajax({
                type: 'POST',
                url: '{{ route('recharges.store') }}',
                processData: false,
                contentType: false,
