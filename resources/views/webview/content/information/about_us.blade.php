...
<div class="container outer-top-xs outer-bottom-xs">
    <div class="row">
        <div class="col-xs-12">
            <h1 id="affiliateh1"><u>About Us</u></h1>
        </div>
    </div>
    <div class="row" id="space"> 
        <div class="col-xs-12 col-md-6">
            <h2 style="margin-top:0px;" class="d-none d-lg-block"> <b>ABOUT US :</b> </h2>
            <h4 id="affh4">
        ...
        <div class="col-xs-12 col-md-5" id="mt-2">
             <img src="{{asset('public/about.webp')}}" style="width:100%;border-radius: 6px;">
        </div> 
    </div>
    <div class="row mb-4" id="space"> 
        <div class="col-xs-12 col-md-5" id="mt-2">
             <img src="{{asset('public/mission.jpg')}}" style="width:100%;border-radius: 6px;">
        </div> 
        <div class="col-md-1"></div>
        <div class="col-xs-12 col-md-6">
            <h2 id="mt-2" style="margin-top:0px;text-align: center;"> <u><b>OUR MISSION</b></u> </h2>
            <h6 id="affh4">
                <b>(1) .</b> The About Us page of your website is an essential source of information for all who want to know more about your business. 
            </h6> 
            <h6 id="affh4">
                <b>(2) .</b> About Us pages are where you showcase your history, what is unique about your work, your company’s values, and who you serve. 
            </h6> 
            <h6 id="affh4">
                <b>(3) .</b> About Us pages are where you showcase your history, what is unique about your work, your company’s values, and who you serve. 
            </h6> 
        </div>
    ...
    <div class="row mb-4" id="space">  
        <div class="col-xs-12 col-md-6">
            <h2 id="mt-2" style="margin-top:0px;text-align: center;"> <u><b>OUR VISION</b></u> </h2>
            <h6 id="affh4">
                <b>(1) .</b> The About Us page of your website is an essential source of information for all who want to know more about your business. 
            </h6> 
            <h6 id="affh4">
        ...
        <div class="col-md-1"></div>
        <div class="col-xs-12 col-md-5" id="mt-2">
             <img src="{{asset('public/vision.jpg')}}" style="width:100%;border-radius: 6px;">
        </div> 
    ...
    <div class="row mb-4" id="space">  
        <div class="col-xs-12 col-md-6">
            <h2 id="mt-2" style="margin-top:0px;"><b>Chairman Speech</b></h2>
            <h6 id="affh4">
                 The About Us page of your website is an essential source of information for all who want to know more about your business. 
            </h6> 
            <h6 id="affh4">
    ...
    <div class="row mb-4" id="space">  
        ...
        <div class="col-md-1"></div>
        <div class="col-xs-12 col-md-6">
            <h2 id="mt-2" style="margin-top:0px;"><b>CEO Speech</b></h2>
            <h6 id="affh4">
                 The About Us page of your website is an essential source of information for all who want to know more about your business. 
            </h6> 
            <h6 id="affh4">
    ...
    <div class="row" id="space">
        <h2 id="mt-2" style="margin-top: 20px;text-align: center;margin-bottom: 24px;color: black;"><u><b>TAKE A TOUR TO US</b></u></h2>
        <div class="col-xs-12 col-md-6">
                    ...
                    <div class="card" id="affcard">
                        <div class="card-body">
                            ...
                            <p style="text-align: justify;padding-top:10px"> 
                                You multiple streams of income on autopilot, even when you're sleeping or enjoying life!
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 item">
                    <div class="card" id="affcard">
                        <div class="card-body">
                            ...
                            <p style="text-align: justify;padding-top:10px">
                                You'll learn how to quickly set up your own automated marketing system that sells for you 24/7 
                            </p>
                        </div>
                    </div>
                </div> 
