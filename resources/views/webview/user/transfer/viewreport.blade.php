...
@section('maincontent')
@section('title')
    {{ env('APP_NAME') }}-Transection Report
@endsection
                        ...
                        <div class="bg-secondary rounded">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-lg-12">
                                            <form action="{{ url('user/fundtransfer/report/download') }}"
                                                method="get">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2 p-2">
                                                        ...
                                                        <select id="wallet" name="wallet" class="form-control">
                                                            <option value="Referral Wallet">Referral Wallet</option>
                                                            <option value="Teammate Wallet">Teammate Wallet</option>
                                                            <option value="Global Wallet">Global Wallet</option>
                                                            <option value="Purchase Wallet">Purchase Wallet</option>
                                                            <option value="Leadership Wallet">Leadership Wallet</option>
                                                    ...
                                                    <div class="form-group col-md-3 pt-4"
                                                        ...
                                                        <button type="submit"
                                                            class="btn btn-info btn-download-wallet"><i
...
<script>
    $(document).ready(function() {
        ...
        var table = $("#reportTable").DataTable({
            type: "get",
            ajax: {
                url: "{{ url('user/fundtransfer/report/data') }}",
                data: {
                    startDate: function() {
        ...
        $(document).on('click', '.btn-download-ff', function() {
            $.ajax({
                type: 'get',
                url: "{{ url('user/fundtransfer/report/download') }}",
                data: {
                    startDate: function() {
                        return $('#startDate').val()
                    },
                ...
                success: function(data) {
                    if (data == 'error') {
                        ...
                        swal({
                            title: "Transfer Report Download Success!",
                            icon: "success",
