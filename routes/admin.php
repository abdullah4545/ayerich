...
Route::group(['prefix'=>'admin','middleware' => ['auth.admin:admin']], function () {
    ...
    Route::post('/referal-generation/update/{id}', [BasicinfoController::class, 'referalinfo']);
    Route::put('/tms/update/{id}', [BasicinfoController::class, 'tms']);
    Route::put('/affiliate/update/{id}', [BasicinfoController::class, 'affiliate']);
    Route::put('/team-work/update/{id}', [BasicinfoController::class, 'TeamWork']);
    ...
    //Rank Bonus
    Route::resource('leadershipranks', LeadershiprankController::class,['names'=>'admin.leadershipranks']);
    Route::get('leadershiprank/get/data', [LeadershiprankController::class, 'leadershiprankdata'])->name('admin.leadershiprank.data');
    Route::post('leadershiprank/{id}', [LeadershiprankController::class, 'update']);
    Route::put('leadershiprank/status', [LeadershiprankController::class, 'statusupdate']);
    ...
    Route::put('product/best-selling', [ProductController::class, 'beststatusupdate']);
    ...
    //Rank Bonus
    Route::resource('ranks', RankController::class,['names'=>'admin.ranks']);
    Route::get('rank/get/data', [RankController::class, 'rankdata'])->name('admin.rank.data');
    Route::post('rank/{id}', [RankController::class, 'update']);
    Route::put('rank/status', [RankController::class, 'statusupdate']);
