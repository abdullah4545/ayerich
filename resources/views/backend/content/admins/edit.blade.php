...
<div class="container-fluid pt-4 px-4">
    <form name="form" id="EditRole" method="POST" action="{{ route('admin.admins.update', $admin->id) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="name" id="floatingInput"
                                    placeholder="Your name here" value="{{ $admin->name }}" required>
                                <label for="floatingInput" style="color: red">Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="email" class="form-control" name="email" id="floatingInput"
                                    placeholder="name@ayebazar.com" value="{{ $admin->email }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="phone" id="floatingInput"
                                    placeholder="Type Phone" value="{{ $admin->phone }}" required>
