                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-xl-12 p-2 pb-0 mb-4"
                        ...
                        <div class="h-100 bg-secondary rounded p-2">
                            <h5 class="card-title text-center mt-2" style="color:black">Withdrew You Money</h5>
                            <p class=" text-center" style="width::100%;color:red;">[ NB: You need to pay
                                {{ \App\Models\Basicinfo::first()->charge_withdrew }}% charge for withdrew money ]</p>

                            <form id="NewWithdrew" name="form" enctype="multipart/form-data"
                                ...
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-md-12 m-auto justify-content-center align-items-center">
                                        ...
                                        <div class="form-group mb-3">
                                            <label for="controlInput1">Withdrew Amount</label>
                                            <input type="number" min="1"
                                                max="{{ intval(Auth::user()->main_balance) }}" class="form-control"
                                                name="amount" placeholder="WIthdrew Amount" required>
                                        </div>
                                        <div class="form-group mb-3">
                    ...
                    <div class="col-sm-12 col-md-12 col-xl-12 p-2 pt-0">
                        <div class="bg-secondary rounded p-2">
                            <h6 class="mb-2 text-center" style="color:black;">Withdrew History</h6>
