                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-xl-12 p-2 pb-0 mb-4"
                        ...
                        <div class="h-100 bg-secondary rounded p-2">
                            <h5 class="card-title text-center mt-2" style="color:black">Royalty Bonus Transfer</h5>
                                ...
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-md-12 m-auto justify-content-center align-items-center">
                                        <div class="form-group mb-3">
                                            <label for="controlInput">From Royalty Balance</label>
                                            <input type="text" class="form-control " id="balance" name="balance"
                                                value="Royalty Balance : {{ intval(Auth::user()->group_bonus) }}"
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" min="1"
                                                max="{{ intval(Auth::user()->group_bonus) }}" class="form-control"
