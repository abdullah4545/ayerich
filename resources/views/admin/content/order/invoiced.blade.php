...
<main id="main" class="main">
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-xl-2">
            <a href="{{ url('admin_order/Checked Invoiced') }}">
                <div class="widget-rounded-circle card-box order pt-1 pb-1">
                    <div class="row">
                        <div class="col-12">
                            <div class="float-left">
                                <h3 class="text-dark mt-1 mb-0">
                                    <span id="checkedInvoiced" data-plugin="counterup">0</span>
                                </h3>
                                <p class="text-muted mb-1 text-truncate">Checked Invoiced</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-9" style="text-align: right">
                                ...
                                @else
                                    ...
                                    @endif
                                @endif
                                @if (last(request()->segments()) == 'Checked Invoiced' || last(request()->segments()) == 'Invoiced')
