    ...
    <div class="container pt-4 mt-4">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <div class="card p-2">
                    <h1 class="text-center">Transfer Your Income</h1>
                    <div class="row p-4">
                        ...
                        <div class="col-lg-6" style="margin: 20px">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" disabled class="form-control" id="from_wallet" value="Income"
                                        name="from_wallet">
                                </div>
                                <div class="form-group">
                                    <label for="Amount">Available Amount</label>
                                    <input type="text" class="form-control"
                                        value="{{ number_format((float) Auth::guard('web')->user()->my_income, 2, '.', '') }}"
                                        id="available_amount" name="available_amount" placeholder="Available Amount">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Transfer To</label>
                                    <select class="form-control form-control-lg" onchange="getamount()" required
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" min="20"
                                        max="{{ number_format((float) Auth::guard('web')->user()->my_income, 2, '.', '') }}"
