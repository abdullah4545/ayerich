                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-xl-12 p-2 pb-0 mb-4"
                        ...
                        <div class="h-100 bg-secondary rounded p-2">
                            <h5 class="card-title text-center mt-2" style="color:black">Transfer form Main balance TO My
                                balance</h5>
                            <p class=" text-center" style="width::100%;color:red;">[ NB: You get
                                {{ \App\Models\Basicinfo::first()->convert_bonus }}% bonus for transfer money ]</p>
                            ...
                            <form id="NewFoundtransfer" name="form" enctype="multipart/form-data"
                                ...
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-md-12 m-auto justify-content-center align-items-center">
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="form-group mb-3">
                                                <label for="controlInput">To Balance</label>
