                    ...
                    <div class="p-2 pt-0">
                        <div class="row">
                            <div class="col-lg-4 mb-2">
                                <div class="card text-center bg-danger pt-4" style="font-size: 26px;background: green;">
                                    <i class="icon fa fa-bookmark text-white"></i>
                                    <p class="text-white mb-0 pt-4"> <span>{{ Cart::count() }}</span> Product</p>
                                    <p class="text-white">Cart</p>
                                </div>
                            </div>
                            <div class="col-lg-4 mb-2">
                                <div class="card text-center bg-danger pt-4"
                                    style="font-size: 26px;background: skyblue;">
                                    <i class="icon fa fa-bookmark text-white"></i>
                                    <p class="text-white mb-0 pt-4"> <span>0</span> Product</p>
                                    <p class="text-white">Save</p>
                                </div>
                            </div>
                            <div class="col-lg-4 mb-2">
                                <div class="card text-center bg-info pt-4" style="font-size: 26px;background: red;">
                                    <i class="icon fa fa-building text-white"></i>
                        ...
                        <div class="row">
                            @if ($orders == 'Nothing')
                                <div class="px-2 py-1 p-md-3 bg-white shadow-sm" style="background: white;">
                                    <div class="search-area pb-4" style="    padding: 20px;">
                                        <h4 class="m-0 text-center pb-4" style="font-size: 30px"> <b>Track You Order
                                                Now</b> </h4>
                                        <form method="POST" action="{{ url('track-now') }}">
                                            @csrf
                                            <div class="form-group d-flex">
                                                <input class="form-control m-0"
                                                    style="height: 52px;font-size: 20px;padding:10px" name="invoiceID"
                            ...
                            @else
                                        ...
                                        <div class="card-header py-2 px-3 heading-6 strong-600 clearfix">
                                            <ul class="process-steps clearfix">
                                                @if ($orders->status == 'Processing' || $orders->status == 'Payment Pending' || $orders->status == 'On Hold')
                                                    <li>
                                                        <div class="icon" style="background:#e62e04;color:white">1
                                                        </div>
                                                ...
                                                @if ($orders->status == 'Completed' ||
                                                    ...
                                                    <li>
                                                        <div class="icon" style="background:#e62e04;color:white">2
                                                        </div>
                                                ...
                                                @if ($orders->status == 'Delivered' ||
                                                    ...
                                                    <li>
                                                        <div class="icon" style="background:#e62e04;color:white">3
                                                        </div>
                                                ...
                                                @if ($orders->status == 'Paid')
                                                    <li>
                                                        <div class="icon" style="background:#e62e04;color:white">4
                                                        </div>
                                ...
                                @else
                                    <div class="card mt-4">
                                        <div class="card-header py-2 px-3 heading-6 strong-600 clearfix">
                                            <div class="float-left" style="color: red;text-align:center">No Records
                                                Found.Please call
